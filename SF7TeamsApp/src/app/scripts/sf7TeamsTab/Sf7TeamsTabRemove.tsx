...
export interface ISf7TeamsTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface ISf7TeamsTabRemoveProps extends ITeamsBaseComponentProps {

}

/**
 * Implementation of SF7 Teams Tab remove page
 */
export class Sf7TeamsTabRemove  extends TeamsBaseComponent<ISf7TeamsTabRemoveProps, ISf7TeamsTabRemoveState> {
